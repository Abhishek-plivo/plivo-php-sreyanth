...
class ConferenceTest extends BaseTestCase
{
    function testConferenceDetails()
    {
        ...
        $actual = $this->client->conference->get("dfshjkasfhjkasfhjkashf");
    ...
    function testConferenceList()
    {
        ...
        $actual = $this->client->conference->list;
    ...
    function testConferenceDeleteAll()
    {
        ...
        $actual = $this->client->conference->deleteAll();
    ...
    function testConferenceDelete()
    {
        ...
        $actual = $this->client->conference->delete("asdasdasdasd");
    ...
    function testConferenceMemberMute()
    {
        ...
        $actual = $this->client->conference->muteMember("asdasdasdasd", ['123']);
    ...
    function testConferenceMemberUnMute()
    {
        ...
        $actual = $this->client->conference->unMuteMember("asdasdasdasd", ['123']);
    ...
    function testConferenceMemberDeaf()
    {
        ...
        $actual = $this->client->conference->makeDeaf("asdasdasdasd", ['123']);
    ...
    function testConferenceMemberHear()
    {
        ...
        $actual = $this->client->conference->enableHearing("asdasdasdasd", ['123','111']);
    ...
    function testConferenceMemberKick()
    {
        ...
        $actual = $this->client->conference->kickMember("asdasdasdasd", '123');
    ...
    function testConferenceMemberPlay()
    {
        ...
        $actual = $this->client->conference->startPlaying("asdasdasdasd", ['123','111','1'], "");
    ...
    function testConferenceMemberSpeak()
    {
        ...
        $actual = $this->client->conference->startSpeaking("asdasdasdasd", ['123'], "this is the text");
    ...
    function testConferenceMemberPlayDelete()
    {
        ...
        $actual = $this->client->conference->stopPlaying("asdasdasdasd", ['123','111','1']);
    ...
    function testConferenceMemberSpeakDelete()
    {
        ...
        $actual = $this->client->conference->stopSpeaking("asdasdasdasd", ['123']);
    ...
    function testConferenceRecord()
    {
        ...
        $actual = $this->client->conference->startRecording("asdasdasdasd");

...
class NumberTest extends BaseTestCase
{
    function testNumberList()
    {
        ...
        $actual = $this->client->number->getList();
    ...
    function testNumberCreate()
    {
        ...
        $actual = $this->client->number->addNumber(['11111'], "car", "IN");
    ...
    function testNumberGet()
    {
        ...
        $actual = $this->client->number->get($number);
    ...
    function testNumberUpdate()
    {
        ...
        $actual = $this->client->number->update($number, ['alias'=>'saila']);
    ...
    function testNumberDelete()
    {
        ...
        $actual = $this->client->number->delete("cxcxcx");

...
class EndpointTest extends BaseTestCase
{
    function testEndpointCreate()
    {
        ...
        $actual = $this->client->endpoint->create(
            "carter", "retrac", "mario"
        );
    ...
    function testEndpointGet()
    {
        ...
        $actual = $this->client->endpoint->get($endpoint);
    ...
    function testEndpointList()
    {
        ...
        $actual = $this->client->endpoint->list;
    ...
    function testEndpointUpdate()
    {
        ...
        $actual = $this->client->endpoint->update(
            "carter", ['alias' => 'hahaha']);
    ...
    function testEndpointDelete()
    {
        ...
        $actual = $this->client->endpoint->delete("cxcxcx");

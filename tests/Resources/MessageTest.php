...
class MessageTest extends BaseTestCase {
    ...
    public function testMessageCreateException()
    {
        ...
        $this->client->message->create(null, ["+919012345678"], "Test");
    ...
    public function testMessageCreate()
    {
        ...
        $actual = $this->client->message->create("+919999999999", ["+919012345678"], "Test");
    ...
    public function testMessageGet()
    {
        ...
        $actual = $this->client->message->get($messageUuid);
    ...
    function testMessageList()
    {
        ...
        $actual = $this->client->message->list;

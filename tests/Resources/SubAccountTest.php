...
class SubAccountTest extends BaseTestCase
{
    function testSubAccountCreate()
    {
        ...
        $actual = $this->client->subAccount->create('name', true);
    ...
    function testSubAccountList()
    {
        ...
        $actual = $this->client->subAccount->list;
    ...
    function testSubAccountGet()
    {
        ...
        $actual = $this->client->subAccount->get($subAccountAuthId);
    ...
    function testSubAccountModify()
    {
        ...
        $subAccount = $this->client->subAccount->get($subAccountAuthId);
    ...
    function testSubAccountDelete()
    {
        ...
        $actual = $this->client->subAccount->delete($subAccountAuthId);

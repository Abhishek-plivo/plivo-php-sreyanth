...
class ApplicationTest extends BaseTestCase
{
    function testApplicationCreate()
    {
        ...
        $actual = $this->client->application->create('app');
    ...
    function testApplicationList()
    {
        ...
        $actual = $this->client->application->list;
    ...
    function testApplicationDetails()
    {
        ...
        $actual = $this->client->application->get("20468599130939380");
    ...
    function testApplicationUpdate()
    {
        ...
        $actual = $this->client->application->update("app", ['subaccount'=>'name']);
